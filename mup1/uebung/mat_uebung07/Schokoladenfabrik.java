...
public class Schokoladenfabrik
{
    ...
    public void simulieren()
    {
        while (!datum.istWeihnachten())
        {
            ...
            // Interieren durch .keySet() um nur Mitarbeiter zu bekommen, die auch vorhanden sind
            // .. sonst diskrepanz in erster if-Abfrage, da ein nicht exitierender Mitarbeiter AUCH null wäre!
    ...
    private void erhoeheProduktZaehler(String produktname)
    {
        ...
        {
        	// DAS WAR LETZTE JAHR IN DER KLAUSUR DRAN
